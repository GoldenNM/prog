...
<html>
    ...
    <body>
        ...
        <main>
            <div id="bloc1">
                <div class="b1"><u>Bottes 2.0</u><img width="400" height="400" src="image/chaussures2.jpg"/></div>
                <div class="b2">    
                    <select id="vetement" name="taille">
                        <optgroup label="taille">
                            <option value="G" selected>39</option>
                            <option vaue="P">40</option>
                            <option value="V">41</option>
                            <option value="B">42</option>
                            <option value="Bat">43</option>
                        </optgroup>

                    </select></div>
                <div class="b3"><p>Ce produit est disponible.</p></div>
                <div class="b4"><p>300 €</p></div>
