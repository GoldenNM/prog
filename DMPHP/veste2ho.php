...
<html>
    ...
    <body>
        ...
        <main>
            <div id="bloc1">
                <div class="b1"><u>Veste en cuire</u><img width="400" height="400" src="image/vesteclassique.jpg"/></div>
                <div class="b2">    
                    <select id="vetement" name="taille">
                        <optgroup label="taille">
                            <option value="G" selected>XS non disponible</option>
                            <option vaue="P">S non disponible</option>
                            <option value="V">M non disponible</option>
                            <option value="B">L non disponible</option>
                            <option value="Bat">XL non disponible</option>
                        </optgroup>

                    </select></div>
                <div class="b3"><p>Ce produit n'est plus disponible.</p></div>
                <div class="b4"><p>150 €</p></div>
                ...
                <div class="b8"><a class="button">Passer commande</a></div>
            </div>
        </main>
    </body>